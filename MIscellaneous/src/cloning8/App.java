...
public class App {
	...
	public static void main(String[] args) throws CloneNotSupportedException {
		...
		System.out.println(student2.getName().hashCode());

		System.out.println("+++++++++++++++++++++++++++");
		System.out.println(student.getCourse().getSubName().hashCode());
		System.out.println(student2.getCourse().getSubName().hashCode());
